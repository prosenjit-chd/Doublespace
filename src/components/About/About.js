    ...
    return (
        <div className="mt-5">
            ...
            <Card className="text-center">
                <Card.Img variant="top" src="https://i.ibb.co/7Vc2NLX/cover.jpg" style={{ 'height': '480px' }} />
                <Card.Header>About Us</Card.Header>
                <Card.Body>
                    <Card.Title style={{ color: "#e6520e" }}>Doublespace History</Card.Title>
            ...
            <Container style={{ "marginTop": "40px" }}>
                <Col xs="12" md="12" lg="12">
                    <h2 className="t-color text-center mb-5">BOARD OF DIRECTORS</h2>
                    <Row xs={1} md={2} lg={2} className="g-4 mb-4">
                        <Card className="h-100 cart-font">
                            <Card.Img variant="top" className="w-50 mx-auto" src="https://i.ibb.co/nDtkbSq/partha.jpg" />
                            <Card.Body>
                                <Card.Title className="text-danger">Partha Balaji</Card.Title>
                        ...
                        <Card className="h-100 cart-font">
                            <Card.Img variant="top" className="w-50 mx-auto" src="https://i.ibb.co/SN5wQYy/jan.jpg" />
                            <Card.Body>
                                <Card.Title className="text-danger">Ganendranath Bala</Card.Title>
                                <Card.Text className="text-dark">
